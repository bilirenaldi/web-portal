...
$bulan = $_POST['bulan'];
$thn = date('Y') ?> 
        <title>Laporan Kas Masuk Bulan <?php echo bulan($bulan); echo "   "; echo "Tahun"; echo "   "; echo $thn?></title>
...
$bulan = $_POST['bulan']; $thn = date('Y'); $thn = date('Y');  ?>
                                    <h4 class="m-t-0 header-title"><b>Laporan kas Masuk Bulan <?php echo bulan($bulan); echo "   "; echo "Tahun"; echo "   "; echo $thn?></b></h4>
...
$bulan = $_POST['bulan'];
$thn = date('Y');
$query=mysqli_query($con,"Select * from  tblkas where MONTH(tanggal) = '$bulan' and YEAR(tanggal)='$thn' and jenis = 'Masuk'");
$cnt=1;
